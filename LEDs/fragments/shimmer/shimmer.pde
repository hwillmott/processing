...
// ShimmerShape[] shimmerShapes;
// ShimmerShape shimmerShape;
import java.util.Iterator;
ArrayList<ShimmerShape> shimmerShapes;
OPC opc;
String printStuff = "";
...
void setup()
{
  ...
  frameRate(10);
  noStroke();
  shimmerShapes = new ArrayList<ShimmerShape>();
  ...
  // shimmerShape = new ShimmerShape(new int [][] {{367, 274},{377, 322},{328, 350},{305, 321}});
  // shimmerShapes = new ShimmerShape[] {
  //   new ShimmerShape(new int [][] {{367, 274},{377, 322},{328, 350},{305, 321}}),
  // }
  shimmerShapes.add(new ShimmerShape(new int [][] {{367, 274},{377, 322},{328, 350},{305, 321}})); // A
  shimmerShapes.add(new ShimmerShape(new int [][] {{403, 282},{514, 282},{516, 396}})); // B
  shimmerShapes.add(new ShimmerShape(new int [][] {{378, 177},{450, 172},{551, 251},{399, 255}})); // C
  shimmerShapes.add(new ShimmerShape(new int [][] {{381, 152},{426, 146},{355, 71}})); // D
  shimmerShapes.add(new ShimmerShape(new int [][] {{353, 231},{297, 279},{242, 223},{324, 95}})); // E
  shimmerShapes.add(new ShimmerShape(new int [][] {{92, 113},{224, 89},{163, 11}})); // F
  shimmerShapes.add(new ShimmerShape(new int [][] {{56, 156},{212, 187},{275, 113}})); // G
  shimmerShapes.add(new ShimmerShape(new int [][] {{105, 190},{150, 207},{100, 255},{52, 226}})); // H
  shimmerShapes.add(new ShimmerShape(new int [][] {{208, 214},{186, 326},{121, 380},{93, 360},{100, 285}})); // I
  shimmerShapes.add(new ShimmerShape(new int [][] {{235, 273},{355, 449},{222, 365}})); // J

}

void mousePressed() {
  printStuff += "{" + mouseX + ", " + mouseY + "},";
}
...
void draw()
{
  ...
  Iterator<ShimmerShape> it = shimmerShapes.iterator();
  while (it.hasNext())
  {
    ShimmerShape shape = it.next();
